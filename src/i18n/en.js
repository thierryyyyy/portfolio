...
const en = {
  ...
  hero: {
    ...
    typedStrings: [
      ...
      "MSc in Computer Science (Year 1)",
      "Graduated Jan 2026",
      "Available for projects",
    ],
    bio: "I recently graduated with a Bachelor's in Computer Science (January 2026) and I am currently pursuing a Master's degree (M1). Passionate about web and mobile development, I build useful, well-crafted applications — from backend logic to polished interfaces.",
    cta_hire: "Contact me",
    cta_cv: "Download CV",
    available: "Available",
    stats: [
      { value: "4+", label: "Projects done" },
      { value: "MSc Y1", label: "Education level" },
    ...
    items: [
      {
        ...
        desc: "Design and development of a cross-platform mobile app (React Native/Expo) for geolocated residence registration (SIGAP project). Implemented multi-step forms, camera and geolocation integration, REST API communication, server response normalization, UI/UX improvements.",
        tags: ["React Native", "Expo", "TypeScript", "Node.js", "REST API", "JWT"],
        current: false,
      },
      {
        role: "Master's Degree in Computer Science (Year 1)",
        company: "University / School (to be specified)",
        period: "January 2026 — Present",
        desc: "First year of Master's in Computer Science. Advanced topics: software architecture, AI, complex project management, and research methodology.",
        tags: ["Software Architecture", "AI", "Advanced Projects", "Research"],
        current: true,
      },
      {
      ...
      {
        role: "Bachelor's Degree in Computer Science (Graduated)",
        company: "ENI · University of Fianarantsoa",
        period: "2024 — January 2026",
        desc: "Graduated with a Professional Bachelor's in General Computer Science. Final project: SIGAP — geolocated mobile census application.",
        tags: ["React Native", "Node.js", "Django", "PostgreSQL"],
        current: false,
      },
      {
        role: "Bachelor's Years 1 & 2 — Computer Science",
        company: "ENI · University of Fianarantsoa",
        period: "2022 — 2024",
